...
@section('content')
    <div class="row seller-page">
        ...
        <div class="col-md-10">
            <!-- Seller Banner -->
            <div class="position-relative text-center supplier-banner mx-auto"
                style="background-image: url('{{ static_asset('assets/img/seller-bg.png') }}');">
                <div
                    class="position-absolute top-0 start-0 w-100 h-100 d-flex flex-column align-items-center justify-content-center p-3">
                    <div class="mb-2" style="width: 80px; height: 80px;">
                        <img src="{{ uploaded_asset($shop->logo) }}" alt="{{ $shop->name }}"
                        ...
                        @if ($shop->verification_status)
                            <div class="icon-container ml-2" data-tooltip="Verified">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                                    <g id="_6819ed6f635ef55dbc567842d82cbaf7" data-name="6819ed6f635ef55dbc567842d82cbaf7"
                                        transform="translate(-1 -1)">
                                        <path id="Path_42581" data-name="Path 42581" d="M9,1a8,8,0,1,0,8,8A8,8,0,0,0,9,1Z"
                                            fill="#00c96c" />
                                        <path id="Path_42582" data-name="Path 42582"
                                            d="M14.822,8.821,9.731,13.912a.727.727,0,0,1-1.029,0L5.793,11,6.821,9.975,9.216,12.37l4.577-4.577Z"
                                            transform="translate(-1.307 -1.853)" fill="#fff" fill-rule="evenodd" />
                                    </g>
                                </svg>
                            </div>
                        @endif
                    ...
                    <div class="d-flex align-items-center mr-2 fs-13">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="12.8" viewBox="0 0 16 12.8">
                            <path id="Path_42644" data-name="Path 42644"
                                ...
                                transform="translate(-2 -4)" fill="#9393a3" />
                        </svg>
                        ...
                        @if ($shop->user->phone)
                            <svg xmlns="http://www.w3.org/2000/svg" width="12.097" height="12" viewBox="0 0 12.097 12">
                                <path id="Path_42645" data-name="Path 42645"
                                    d="M9.621,13.151a5.627,5.627,0,0,1-2.492-.675A13.134,13.134,0,0,1,3.754,9.984,13.472,13.472,0,0,1,1.262,6.609C.38,4.792.328,3.286,1.21,2.456a.5.5,0,0,1,.727,0,.5.5,0,0,1,0,.727c-.519.519-.415,1.661.26,3.011A12.257,12.257,0,0,0,4.481,9.309,12.257,12.257,0,0,0,7.6,11.593c1.35.675,2.492.779,3.011.26a.514.514,0,0,1,.727.727,2.523,2.523,0,0,1-1.713.571Z"
                                    transform="translate(0 -1.065)" fill="#9393a3" />
                                <path id="Path_42646" data-name="Path 42646"
                                    d="M4.771,5.6A.5.5,0,0,1,4.3,5.285a.458.458,0,0,1,.208-.675l1.194-.571a.7.7,0,0,0,.415-.675A.525.525,0,0,0,5.913,3L4.2,1.235a.749.749,0,0,0-.675-.156l-.311.156-.831.883a.514.514,0,0,1-.727-.727L2.486.56A1.48,1.48,0,0,1,3.213.145,1.862,1.862,0,0,1,4.926.56L6.64,2.274a1.754,1.754,0,0,1,.467.986,1.792,1.792,0,0,1-.986,1.765L4.926,5.6c0-.052-.1,0-.156,0Zm6.593,6.022A.471.471,0,0,1,11,11.463a.5.5,0,0,1,0-.727l.831-.831a.37.37,0,0,0,.156-.311.749.749,0,0,0-.156-.675L10.118,7.206A1.3,1.3,0,0,0,9.755,7a.63.63,0,0,0-.675.415L8.509,8.607a.5.5,0,1,1-.883-.467L8.2,6.946A1.75,1.75,0,0,1,9.962,5.96a1.611,1.611,0,0,1,.934.467L12.61,8.14a1.625,1.625,0,0,1,.415,1.713,2.037,2.037,0,0,1-.415.727l-.883.883A.471.471,0,0,1,11.364,11.619Z"
                                    transform="translate(-0.445 0)" fill="#9393a3" />
                                <path id="Path_42647" data-name="Path 42647"
                                    d="M10.557,12.973a.738.738,0,0,1-.311-.1q-.934-.7-1.869-1.557A12.376,12.376,0,0,1,6.819,9.443a.527.527,0,0,1,.156-.727.549.549,0,0,1,.727.1,11.069,11.069,0,0,0,1.454,1.713,21.258,21.258,0,0,0,1.713,1.454.466.466,0,0,1,.1.727c-.052.208-.208.26-.415.26Z"
                                    transform="translate(-2.961 -4.106)" fill="#9393a3" />
                            </svg>
                        ...
                        <ul class="nav nav-tabs supplier-tab" id="customTabs">
                            ...
                            <li class="nav-item">
                                <button class="nav-link"
                                    onclick="changeSellerTab(this, 'overview')">{{ translate('Overview') }}</button>
                            </li>

                            <li class="nav-item">
                                <button class="nav-link"
                                    onclick="changeSellerTab(this, 'products')">{{ translate('Items') }}</button>
                            </li>
                            <li class="nav-item">
                                <button id="order_tab" class="nav-link"
                                    onclick="changeSellerTab(this, 'orders')">{{ translate('Orders') }}</button>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <button class="nav-link" onclick="changeSellerTab(this, 'purchase_history')">
                                    Purchase History
                                </button>
                            </li>
                        ...
                        <div class="dropdown d-lg-none mb-2">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <button class="dropdown-item d-flex align-items-center"
                                    onclick="changeSellerTab(this, 'orders' , 'order_tab')">
                                    <!-- SVG icon -->
                                    <svg xmlns="http://www.w3.org/2000/svg" width="12.699" height="16"
                                        viewBox="0 0 12.699 16">
                                ...
                                @can('mark_seller_suspected')
                                    @if ($shop->user->is_suspicious == 1)
                                        <a href="javascript:void();"
                                            onclick="confirm_suspicious('{{ route('seller.suspicious', encrypt($shop->user->id)) }}', true);"
                                            class="dropdown-item">
                                            {{ translate(' Mark as ' . ($shop->user->is_suspicious == 1 ? 'unsuspect' : 'suspicious') . ' ') }}
                                        </a>
                                    @else
                                        <a href="javascript:void();"
                                            onclick="confirm_suspicious('{{ route('seller.suspicious', encrypt($shop->user->id)) }}', false);"
                                            class="dropdown-item">
                                            {{ translate(' Mark as ' . ($shop->user->is_suspicious == 1 ? 'unsuspect' : 'suspicious') . ' ') }}
                                        </a>
                                    @endif
                                ...
                                @can('delete_seller')
                                    <a href="javascript:void();" class="dropdown-item text-danger confirm-delete"
                                        data-href="{{ route('sellers.destroy', $shop->id) }}">
                                        {{ translate('Delete') }}
                                    </a>
                                @endcan
                            </div>
    ...
    <script>
        ...
        function show_seller_payment_modal(id) {
            $.post('{{ route('sellers.payment_modal') }}', {
                ...
                $('#seller_common_modal').modal('show', {
                    backdrop: 'static'
                });
