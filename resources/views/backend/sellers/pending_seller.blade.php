                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="{{ uploaded_asset($shop->logo) }}" class="size-40px img-fit mr-2"
                                ...
                                <td>
                                    <label class="aiz-switch aiz-switch-success mb-0">
                                        <input @can('approve_seller') onchange="update_approved(this)" @endcan
                                            value="{{ $shop->id }}" type="checkbox" <?php if ($shop->registration_approval == 1) {
                                                echo 'checked';
                                            } ?>
                                ...
                                <td>
                                    @can('delete_seller')
                                        <a href="javascript:void();" class="badge badge-inline badge-danger confirm-delete"
