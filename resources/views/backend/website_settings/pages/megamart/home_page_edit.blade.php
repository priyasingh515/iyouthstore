        ...
        <div class="d-sm-flex">
            ...
            <div class="page-side-nav c-scrollbar-light px-3 py-2">
                <ul class="nav nav-tabs flex-sm-column border-0" role="tablist" aria-orientation="vertical">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#mobile_slider" data-toggle="tab">
                            Mobile Slider
                        </a>
                    </li>
                    <!-- Flash Deals -->
                    ...
                    <!-- Banner Level 4 -->
                    <li class="nav-item">
                        <a class="nav-link" id="banner-4-tab" href="#banner_4" data-toggle="tab" data-target="#banner_4"
                            type="button" role="tab" aria-controls="banner_4" aria-selected="false">
                    ...
                    <!-- Banner Level 5 -->
                    <li class="nav-item">
                        <a class="nav-link" id="banner-5-tab" href="#banner_5" data-toggle="tab"
                            data-target="#banner_5" type="button" role="tab" aria-controls="banner_5"
                            aria-selected="false">
                    ...
                    <!-- Banner Level 6 -->
                    <li class="nav-item">
                        <a class="nav-link" id="banner-6-tab" href="#banner_6" data-toggle="tab"
                            data-target="#banner_6" type="button" role="tab" aria-controls="banner_6"
                            aria-selected="false">
            ...
            <div class="flex-grow-1 p-sm-3 p-lg-2rem mb-2rem mb-md-0">
                <div class="tab-content">
                                    ...
                                    <div class="col-lg-5 order-lg-1 mb-3">
                                        <div class="p-4 border h-250px h-lg-300px" style="background: #fcfcfc;">
                                            ...
                                            <div class="form-group ml-4 d-inline-block">
                                                <label class="aiz-checkbox">
                                                    <input type="hidden" name="types[]"
                                                        value="slider_section_full_width">
                                                    <input type="checkbox" class="check-one"
                                                        name="slider_section_full_width" value="1"
                                                        @if (get_setting('slider_section_full_width') == 1) checked @endif>
                                                    <span
                                                        class="fs-13 fw-400">{{ translate('Use Slider as full width') }}</span>
                                            ...
                                            <div class="form-group ml-4">
                                                <label
                                                    class="col-from-label">{{ translate('Select background color in this section') }}</label>
                                                <div class="input-group mb-3">
                                                    <input type="hidden" name="types[]" value="slider_section_bg_color">
                                                    <input type="text" class="form-control aiz-color-input"
                                                        placeholder="#000000" name="slider_section_bg_color"
                                                        value="{{ get_setting('slider_section_bg_color') }}">
                                    ...
                                    <div class="col-lg-7">
                                        <div class="w-100">
                                                ...
                                                <div>
                                                    <svg id="_79508b4b8c932dcad9066e2be4ca34f2"
                                                        ...
                                                        <circle id="Ellipse_813" data-name="Ellipse 813" cx="1"
                                                            cy="1" r="1" transform="translate(8 3.333)"
                                                            fill="#9da3ae" />
                                            ...
                                            <div class="home-slider-target">
                                                @php
                                                    $home_slider_images = get_setting(
                                                        'home_slider_images',
                                                        null,
                                                        $lang,
                                                    );
                    ...
                    <div class="tab-pane fade" id="mobile_slider">

                        <form action="{{ route('business_settings.update') }}" method="POST"
                            enctype="multipart/form-data">
                            @csrf

                            <input type="hidden" name="tab" value="mobile_slider">
                            <input type="hidden" name="types[][{{ $lang }}]" value="home_slider_images_mobile">
                            <input type="hidden" name="types[][{{ $lang }}]" value="home_slider_links_mobile">

                            <div class="bg-white p-3 p-sm-2rem">

                                <div class="home-mobile-slider-target">

                                    @php
                                        $mobile_images = get_setting('home_slider_images_mobile', null, $lang);
                                        $mobile_links = get_setting('home_slider_links_mobile', null, $lang);
                                    @endphp

                                    @if ($mobile_images != null)
                                        @foreach (json_decode($mobile_images, true) as $key => $value)
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-5">
                                                        <div class="input-group" data-toggle="aizuploader"
                                                            ...
                                                            <input type="hidden" name="home_slider_images_mobile[]"
                                                                class="selected-files" value="{{ json_decode($mobile_images, true)[$key] }}">
                                                        </div>
                                                    ...
                                                    <div class="col-md">
                                                        <input type="text" class="form-control"
                                                          ...
                                                          value="{{ isset(json_decode($mobile_links, true)[$key]) ? json_decode($mobile_links, true)[$key] : '' }}"
                                                            placeholder="http://">
                                                    </div>
                                ...
                                <!-- ADD BUTTON -->
                                <button type="button" class="btn btn-block btn-light" data-toggle="add-more"
                                    data-target=".home-mobile-slider-target"
                                    data-content='
                    <div class="p-3 mb-3 remove-parent" style="border: 1px dashed #e4e5eb;">
                        <div class="row">
                            <div class="col-md-5">
                            ...
                            <div class="col-md">
                                <input type="text" class="form-control" name="home_slider_links_mobile[]" placeholder="http://">
                            </div>
                            <div class="col-md-auto">
                                <button type="button" class="btn btn-danger btn-sm" data-toggle="remove-parent" data-parent=".remove-parent">✕</button>
                            </div>
                        </div>
                    </div>'>
                            ...
                            <div class="bg-white p-3 p-sm-2rem">
                                <div class="w-100">
                                    ...
                                    <div class="small text-muted mb-3">
                                        {{ translate('Minimum dimensions required: 315px width X 370px height.') }}</div>
                            ...
                            <div class="bg-white p-3 p-sm-2rem">
                                <div class="w-100">
                                    <label
                                        class="col-from-label fs-13 fw-500 mb-0">{{ translate('Banner & Links (Max 3)') }}</label>
                                    <div class="small text-muted mb-3">
                                        {{ translate('Minimum dimensions required: 1370px width X 450px height (If use a single banner).') }}
                                    </div>
                            ...
                            <div class="bg-white p-3 p-sm-2rem">
                                <div class="w-100">
                                    <label
                                        class="col-from-label fs-13 fw-500 mb-0">{{ translate('Banner & Links (Max 3)') }}</label>
                                    <div class="small text-muted mb-3">
                                        {{ translate('Minimum dimensions required: 432px width X 655px height.') }}</div>
                            ...
                            <div class="bg-white p-3 p-sm-2rem">
                                <div class="w-100">
                                    <label
                                        class="col-from-label fs-13 fw-500 mb-0">{{ translate('Banner & Links (Max 3)') }}</label>
                                    <div class="small text-muted mb-3">
                                        {{ translate('Minimum dimensions required: 896px width X 655px height.') }}</div>
                                                ...
                                                <div class="p-3 p-md-4 mb-3 mb-md-2rem remove-parent"
                                                    ...
                                                    <div class="row gutters-5">
                                                            ...
                                                            <div class="form-group mb-md-0">
                                                                <div class="input-group" data-toggle="aizuploader"
                                                                    ...
                                                                    <input type="hidden" name="home_banner4_images[]"
                                                                        class="selected-files"
                                                                        value="{{ json_decode($home_banner4_images, true)[$key] }}">
                                                                </div>
                                                                <div class="file-preview box sm">
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-md">
                                                            <div class="form-group mb-md-0">
                                                                <input type="text" class="form-control"
                                                                    placeholder="http://" name="home_banner4_links[]"
                                                                    value="{{ isset(json_decode($home_banner4_links, true)[$key]) ? json_decode($home_banner4_links, true)[$key] : '' }}">
                                                            </div>
                                                        </div>
                                                        <!-- remove parent button -->
                                                        <div class="col-md-auto">
                                                ...
                                                <div class="p-3 p-md-4 mb-3 mb-md-2rem remove-parent"
                                                    ...
                                                    <div class="row gutters-5">
                                                            ...
                                                            <div class="form-group mb-md-0">
                                                                <div class="input-group" data-toggle="aizuploader"
                                                                    ...
                                                                    <input type="hidden" name="home_banner5_images[]"
                                                                        class="selected-files"
                                                                        value="{{ json_decode($home_banner5_images, true)[$key] }}">
                                                                </div>
                                                                <div class="file-preview box sm">
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-md">
                                                            <div class="form-group mb-md-0">
                                                                <input type="text" class="form-control"
                                                                    placeholder="http://" name="home_banner5_links[]"
                                                                    value="{{ isset(json_decode($home_banner5_links, true)[$key]) ? json_decode($home_banner5_links, true)[$key] : '' }}">
                                                            </div>
                                                        </div>
                                                        <!-- remove parent button -->
                                                        <div class="col-md-auto">
                                                ...
                                                <div class="p-3 p-md-4 mb-3 mb-md-2rem remove-parent"
                                                    ...
                                                    <div class="row gutters-5">
                                                            ...
                                                            <div class="form-group mb-md-0">
                                                                <div class="input-group" data-toggle="aizuploader"
                                                                    ...
                                                                    <input type="hidden" name="home_banner6_images[]"
                                                                        class="selected-files"
                                                                        value="{{ json_decode($home_banner6_images, true)[$key] }}">
                                                                </div>
                                                                <div class="file-preview box sm">
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-md">
                                                            <div class="form-group mb-md-0">
                                                                <input type="text" class="form-control"
                                                                    placeholder="http://" name="home_banner6_links[]"
                                                                    value="{{ isset(json_decode($home_banner6_links, true)[$key]) ? json_decode($home_banner6_links, true)[$key] : '' }}">
                                                            </div>
                                                        </div>
                                                        <!-- remove parent button -->
                                                        <div class="col-md-auto">
                    ...
                    <div class="tab-pane fade" id="featuredPreorder" role="tabpanel" aria-labelledby="banner-1-tab">
                        <form action="{{ route('business_settings.update') }}" method="POST"
                            ...
                            <input type="hidden" name="types[][{{ $lang }}]"
                                value="featuredPreorder_images">
                            <input type="hidden" name="types[][{{ $lang }}]"
                                value="featuredPreorder_links">
                            ...
                            <div class="bg-white p-3 p-sm-2rem">
                                <div class="w-100">
                                    ...
                                    <div class="home-banner1-target">
                                        @php
                                            $featuredPreorder_images = get_setting(
                                                'featuredPreorder_images',
                                                null,
                                                $lang,
                                            );
                                            $featuredPreorder_links = get_setting(
                                                'featuredPreorder_links',
                                                null,
                                                $lang,
                                            );
                                        @endphp
                                                    ...
                                                    <div class="row gutters-5">
                                                            ...
                                                            <div class="form-group mb-md-0">
                                                                <div class="input-group" data-toggle="aizuploader"
                                                                    ...
                                                                    <div class="form-control file-amount">
                                                                        {{ translate('Choose File') }}</div>
                                                                    <input type="hidden"
                                                                        name="featuredPreorder_images[]"
                                                                        class="selected-files"
                                                                        value="{{ json_decode($featuredPreorder_images, true)[$key] }}">
                                                                </div>
                                                                <div class="file-preview box sm">
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-md">
                                                            <div class="form-group mb-md-0">
                                                                <input type="text" class="form-control"
                                                                    placeholder="http://"
                                                                    name="featuredPreorder_links[]"
                                                                    value="{{ isset(json_decode($featuredPreorder_links, true)[$key]) ? json_decode($featuredPreorder_links, true)[$key] : '' }}">
                                                            </div>
                                                        </div>
                                                        <!-- remove parent button -->
                                                        <div class="col-md-auto">
