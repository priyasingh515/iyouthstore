							...
							<div class="border-top pt-3">
								...
								<div class="form-group row">
									...
									<div class="col-md-8">
										...
										<div class="file-preview"></div>
										<small
											class="text-muted">{{ translate('Will be shown in large device. Minimum dimensions required: 1920px width X 60px height.') }}</small>
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-md-8">
										...
										<div class="file-preview"></div>
										<small
											class="text-muted">{{ translate('Will be shown in medium device. Minimum dimensions required: 810px width X 40px height.') }}</small>
									</div>
								</div>
								<!-- Topbar Banner Small -->
								<div class="form-group row">
									...
									<div class="col-md-8">
										...
										<div class="file-preview"></div>
										<small
											class="text-muted">{{ translate('Will be shown in small device. Minimum dimensions required: 428px width X 40px height.') }}</small>
									</div>
								</div>
								<!-- Topbar Banner Link -->
								<div class="form-group row">
