                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="text" name="phone" value="{{ $user->phone }}" id="phone"
                            class="form-control" placeholder="{{ translate('Your Phone') }}">
                        @error('phone')
                            <small class="form-text text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-10">
                        <div class="input-group mb-3">
                            <input type="text" class="form-control rounded-0"
                                placeholder="{{ translate('Enter Your Verification Code') }}" name="code"
                                value="" disabled />
                            <div class="input-group-append">
...
@section('script')
    ...
    <script>
        ...
        $('#profileUpdateForm').on('submit', function(e) {
            ...
            let passwordChanged = password && password.length > 0;

            if (noProfileChange && !passwordChanged) {
                e.preventDefault();
                AIZ.plugins.notify('warning', 'No changes detected');
                return false;
            }
